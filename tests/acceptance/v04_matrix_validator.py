...
_CONTRACT_IDS = {
    ...
    "V04-C-LONG-LAG-BOOTSTRAP-UNCERTAINTY-V1",
    "V04-C-LONG-LAG-MATURITY-V1",
    "V04-C-LONG-LAG-PROFILE-V1",
    "V04-C-LONG-LAG-SYNTHETIC-CASES-V1",
...
_CASE_IDS = {
    ...
    "V04-A-LONG-LAG-BOOTSTRAP-FAILURE-V1",
    "V04-A-LONG-LAG-MATURITY-BOUNDARY-V1",
    "V04-A-LONG-LAG-MISSINGNESS-V1",
    "V04-A-LONG-LAG-NULL-V1",
    "V04-A-LONG-LAG-UNCERTAINTY-SIGNAL-V1",
